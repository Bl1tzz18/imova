...
namespace Imova.Infrastructure.Migrations
{
    ...
    [Migration("20260925163951_AddFlaggedMessageResolution")]
    partial class AddFlaggedMessageResolution
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Imova.Domain.Messaging.Message", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("FlagResolvedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("FlagResolvedByUserId")
                        .HasColumnType("uuid");
