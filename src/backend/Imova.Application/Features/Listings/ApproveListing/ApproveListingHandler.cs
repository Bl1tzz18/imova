...
public class ApproveListingHandler(IApplicationDbContext dbContext, IBlobStorageService blobStorageService)
    : IRequestHandler<ApproveListingCommand, ListingDto?>
{
